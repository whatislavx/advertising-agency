        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    cancelEditing(); // Використовуємо функцію скасування для повернення UI в початковий стан
                } else {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        function toggleModal(show) {
            ...
            if (show) {
                ...
                passwordModal.classList.add('flex'); // Важливо для центрування
            } else {
        ...
        // Закриття при кліку за межами модалки
        if (passwordModal) {
        ...
        if (passwordForm) {
            passwordForm.addEventListener('submit', (e) => __awaiter(this, void 0, void 0, function* () {
                e.preventDefault();
                if (passwordError) passwordError.classList.add('hidden');
